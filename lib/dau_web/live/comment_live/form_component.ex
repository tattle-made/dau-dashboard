defmodule DAUWeb.CommentLive.FormComponent do
  ...
  def update(%{comment: comment} = assigns, socket) do
    changeset = Verification.change_comment(comment)
  ...
  def handle_event("validate", %{"comment" => comment_params}, socket) do
    changeset =
      ...
      |> Verification.change_comment(comment_params)
  ...
  defp save_comment(socket, :edit, comment_params) do
    case Verification.update_comment(socket.assigns.comment, comment_params) do
      {:ok, comment} ->
  ...
  defp save_comment(socket, :new, comment_params) do
    case Verification.create_comment(comment_params) do
      {:ok, comment} ->
        notify_parent({:saved, comment})
