defmodule DAUWeb.Router do
  ...
  scope "/", DAUWeb do
    ...
    live "/feed-open", OpenDataLive.FeedOpenLive, :index
    live "/other-sources-open", OpenDataLive.OtherSourcesOpenLive, :index
    live "/open-data", OpenDataLive.OpenDataIndexLive, :index
  end
