...
[
  ...
  %{
    media_urls: [
      """
      More diverse URL, total 14,
      http://example.com,
      https://example.com,
      example.com,
      www.example.com,
      https://sub1.sub2.domain.co.uk,
      http://example.com:8080/path,
      https://example.com/assets/image.png,
      https://example.com/search?q=phoenix+regex#top,
      https://example.com/v1.2.3/release.notes.txt,
      https://example.com/docs,
      https://example.com,
      https://my-site-name.example-domain.io/path,
      https://example.com/search?query=foo%20bar%26baz,
      m.timesofindia.com/city/.../48917555.cms,
      """
    ],
    media_type: "text",
    sender_number: "0000000000",
