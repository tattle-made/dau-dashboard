defmodule DAU.UserMessage.Templates.BspToDashboardIntegrationTest do
  ...
  describe "response text for all scenarios" do
    ...
    test "ai_gen_wo_ar_0fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "ai_gen_wo_ar_0fc_hi",
          language: :hi,
          template_parameters: []
        }
      }
    ...
    test "ai_gen_w_ar_0fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "ai_gen_w_ar_0fc_hi",
          language: :hi,
          template_parameters: [
            assessment_report: "https:dau.mcaindia.in/assessment-report-1"
          ]
    ...
    test "ai_gen_wo_ar_1fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "ai_gen_wo_ar_1fc_hi",
          language: :hi,
          template_parameters: [
            factcheck_articles: [
              %{domain: "Publisher One", url: "https://publisher-one.com/article-1"}
    ...
    test "ai_gen_wo_ar_2fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "ai_gen_wo_ar_2fc_hi",
          language: :hi,
          template_parameters: [
            factcheck_articles: [
              %{domain: "Publisher One", url: "https://publisher-one.com/article-1"},
    ...
    test "not_ai_gen_wo_ar_0fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "not_ai_gen_wo_ar_0fc_hi",
          language: :hi,
          template_parameters: []
        }
      }
    ...
    test "not_ai_gen_wo_ar_1fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "not_ai_gen_wo_ar_1fc_hi",
          language: :hi,
          template_parameters: [
            factcheck_articles: [
              %{domain: "Publisher One", url: "https://publisher-one.com/article-1"}
    ...
    test "not_ai_gen_wo_ar_2fc_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "not_ai_gen_wo_ar_2fc_hi",
          language: :hi,
          template_parameters: [
            factcheck_articles: [
              %{domain: "Publisher One", url: "https://publisher-one.com/article-1"},
    ...
    test "out_of_scope_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "out_of_scope_hi",
          language: :hi,
          template_parameters: []
        }
      }
    ...
    test "unsupported_lang_hi" do
      template = %Template{
        meta: %{
          valid: true,
          template_name: "unsupported_lang_hi",
          language: :hi,
          template_parameters: []
        }
      }
